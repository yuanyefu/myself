...
import com.docker.yyf.entity.GetFunction;
...
public class ExcelUtil {
    ...
    public static boolean export2File(ExcelExportData setInfo,
                                      String outputExcelFileName, String type, GetFunction function) throws Exception {
        return FileUtil.write(outputExcelFileName, export2ByteArray(setInfo,type,function),
                true, true);
    }   /**
     * 导出文件
     *
     ...
     * @throws IOException
     */
    public static byte[] exportByte(ExcelExportData setInfo,
                                      String outputExcelFileName, String type, GetFunction function) throws Exception {
        return  export2ByteArray(setInfo,type,function);
    }
    public static boolean export2File(ExcelExportData setInfo,
                                      String outputExcelFileName) throws Exception {
        return FileUtil.write(outputExcelFileName, export2ByteArray(setInfo,null,null),
                true, true);
    }
     ...
     * @throws Exception
     */
    public static byte[] export2ByteArray(ExcelExportData setInfo,String type,GetFunction getFunction)
            throws Exception {
        return export2Stream(setInfo,type,getFunction).toByteArray();
    }
     ...
     * @throws Exception
     */
    public static ByteArrayOutputStream export2Stream(ExcelExportData setInfo,String type,GetFunction function)
            throws Exception {
        init();
    ...
    private static <T>  String te11(T name,GetFunction<T> function){
